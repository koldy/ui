...
const TextDocs = function ({component}) {
	return (
		<Props title={`Props for ${component}.Text`} hash={`${component}-text-props`}>
			...
			<Props.Prop name="flex" type={['string', 'number']} defaultValue="unset">
			...
			<Props.Prop name="alignSelf" type="string" defaultValue="unset">
			...
			<Props.Prop name="color" type="string">
				You can pass any color from a color set in theme, including a color tone.
			</Props.Prop>
			<Props.Prop name="fontSize" type={['string', 'number']}>
				Standard font size for the text inside.
			</Props.Prop>
			<Props.Prop name="p" />
			<Props.Prop name="pt" />
			<Props.Prop name="pr" />
